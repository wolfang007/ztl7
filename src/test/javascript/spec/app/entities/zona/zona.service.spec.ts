...
describe('Service Tests', () => {
  describe('Zona Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ZonaService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Zona(0, 'AAAAAAA', EntityStatus.ATTIVO);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Zona', () => {
        ...
        service.create(new Zona()).subscribe(resp => (expectedResult = resp.body));
