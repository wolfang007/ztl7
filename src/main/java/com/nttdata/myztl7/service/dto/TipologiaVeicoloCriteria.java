...
/**
 * Criteria class for the {@link com.nttdata.myztl7.domain.TipologiaVeicolo} entity. This class is used
 * in {@link com.nttdata.myztl7.web.rest.TipologiaVeicoloResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /tipologia-veicolos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TipologiaVeicoloCriteria implements Serializable, Criteria {
    ...
    public TipologiaVeicoloCriteria() {}

    public TipologiaVeicoloCriteria(TipologiaVeicoloCriteria other) {
    ...
    @Override
    public TipologiaVeicoloCriteria copy() {
        return new TipologiaVeicoloCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TipologiaVeicoloCriteria that = (TipologiaVeicoloCriteria) o;
        return (
    ...
    public String toString() {
        return "TipologiaVeicoloCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (nome != null ? "nome=" + nome + ", " : "") +
