package com.nttdata.myztl7.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("myztl7");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("myztl7");
        ...
        config.getMapConfigs().put("com.nttdata.myztl7.domain.*", initializeDomainMapConfig(jHipsterProperties));
